...
class Submission(models.Model):
    ...
    # 所属比赛
    contest = models.ForeignKey("contests.Contest", verbose_name="所属比赛", related_name="submissions", on_delete=models.CASCADE)
    # 提交关联的题目
    challenge = models.ForeignKey("challenges.Challenge", verbose_name="题目", related_name="submissions", on_delete=models.CASCADE)
    # 提交人
    user = models.ForeignKey(User, verbose_name="用户", related_name="submissions", on_delete=models.CASCADE)
    # 提交人所在队伍（可为空，用于个人赛）
    team = models.ForeignKey("contests.Team", verbose_name="队伍", related_name="submissions", on_delete=models.SET_NULL, null=True, blank=True)
    # 提交的原始 Flag
    ...
    # 对应的解题记录（仅正确时关联）
    solve = models.ForeignKey("challenges.ChallengeSolve", verbose_name="解题记录", related_name="submissions", on_delete=models.SET_NULL, null=True, blank=True)
    # 创建时间
