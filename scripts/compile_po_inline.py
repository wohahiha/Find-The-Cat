...
"""
简易 PO → MO 编译脚本（纯 Python 版）
用途：在缺少 GNU gettext 的环境下，编译 locale/zh_Hans/LC_MESSAGES/django.po 到 .mo
使用：
  python scripts/compile_po_inline.py locale/zh_Hans/LC_MESSAGES/django.po
"""
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scripts/compile_po_inline.py <path/to/file.po>")
        sys.exit(1)
